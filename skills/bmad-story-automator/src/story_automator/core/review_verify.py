...
from .parse_contracts import verifier_exception_payload
...
def verify_code_review_completion(
    ...
    *,
    ...
    try:
        ...
        return verifier_exception_payload("review_contract_invalid", exc, source="verify-code-review", input=story_key)
