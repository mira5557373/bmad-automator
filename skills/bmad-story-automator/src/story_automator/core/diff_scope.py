...
DEFAULT_FILE_CATEGORY_MAP: dict[str, frozenset[str]] = {
    "*.py": frozenset({"correctness", "static", "security", "test_quality", "mutation"}),
    "*.pyi": frozenset({"static"}),
    "*.ts": frozenset({"correctness", "static", "security", "test_quality", "mutation"}),
    "*.tsx": frozenset({"correctness", "static", "security", "accessibility", "test_quality", "mutation"}),
    "*.js": frozenset({"correctness", "static", "security", "test_quality", "mutation"}),
    "*.jsx": frozenset({"correctness", "static", "security", "accessibility", "test_quality", "mutation"}),
    "*.sql": frozenset({"migrations", "security"}),
    "*.tf": frozenset({"security", "compliance"}),
    "*.hcl": frozenset({"security", "compliance"}),
    "*.md": frozenset({"docs"}),
    "*.yaml": frozenset({"invariants", "compliance", "agentic"}),
    "*.yml": frozenset({"invariants", "compliance", "agentic"}),
    "*.rego": frozenset({"agentic"}),
    "*.tool.json": frozenset({"agentic"}),
