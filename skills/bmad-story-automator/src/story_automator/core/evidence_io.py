...
from .evidence_io_cleanup import (
...
# Re-exports preserved for backward compat; symbols defined in
# :mod:`evidence_io_cleanup`. The K-5 quarantine + janitor helpers were
# split into a sibling module so :mod:`evidence_io` stays under the
# CLAUDE.md 500-LOC soft cap (Conventions / shared invariant #5).
__all__ = (
    "get_gate_cleanup_root",
    "run_cleanup_janitor",
)
