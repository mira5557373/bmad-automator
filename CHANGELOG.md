...
- feat(policy): allow optional profile/gate top-level keys (ff49490)
- feat(profile): deterministic hash + snapshot + replay loader (54f026e)
- feat(profile): is_story_blocked maps story IDs to open-ADR blockers (936a8fa)
- feat(profile): add required_for_priority, toolchain_for, rule_for accessors (cb73ea5)
- feat(profile): layered loader with project override + env var selection (2f76edd)
- feat(profile): validate ancillary + §6.4 fields (398d732)
- feat(profile): validate profile shape (top-level keys, matrix, categories) (38526f4)
- feat(profile): add ProfileError, schema constants, bundled default loader (1334532)
...
- docs(spec): add Non-functional requirements + Out of scope sections (0e5fdc6)
- docs(spec,plan): third adversarial validation pass — 10 must-fix items folded in (676b117)
- docs(spec,plan): second adversarial validation pass — 10 must-fix items folded in (fd9cc93)
- docs(plan): M15 Product Profile implementation plan + M16-M19 roadmap (08d9bbd)
- docs(spec): production-ready factory design — deterministic gate program (4711129)
