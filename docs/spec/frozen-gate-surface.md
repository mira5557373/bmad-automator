...
| Phase | Scope | Status |
|---|---|---|
| 0 | Audit-floor regression net + this frozen-surface doc | this commit |
| 1 | VerifyOutcome + git_utils + baseline-commit lie detector + collector try/except wrapping | next |
| 2 | result.json schema + worktree_recovery + fail_closed flag + api_version stamp | after 1 |
